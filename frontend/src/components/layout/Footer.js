      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-b border-gray-700 pb-8 mb-8">
          ...
          <div>
            ...
            <p>Discord: <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="text-yellow-400 hover:underline">Lọ Tự</a></p>
            <p>Server: <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="text-yellow-400 hover:underline">kingmc.vn</a></p>
          </div>
        </div>
